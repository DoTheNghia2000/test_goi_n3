const vocabData = [
   ...
   },
   {
      ...
      pos: "Tính từ な",
      meaning: "hạnh phúc",
      exampleJa: "幸せな家庭を築きたい。",
      exampleVi: "Tôi muốn xây dựng một gia đình hạnh phúc."
   },
   {
      kanji: "不幸せな",
      hiragana: "ふしあわせな",
      pos: "Tính từ な",
      meaning: "bất hạnh",
      exampleJa: "不幸せな出来事が続いた。",
      exampleVi: "Những sự việc bất hạnh liên tiếp xảy ra."
   },
   {
      kanji: "得意な",
      hiragana: "とくいな",
      pos: "Tính từ な",
      meaning: "giỏi về, sở trường",
      exampleJa: "私は料理が得意です。",
   ...
   },
   {
      ...
      hiragana: "とくいなにする",
      pos: "Cụm từ",
      meaning: "làm cho thành sở trường",
      exampleJa: "英語を得意なにしたい。",
      exampleVi: "Tôi muốn biến tiếng Anh thành sở trường."
   },
   {
      kanji: "不得意な",
      hiragana: "ふとくいな",
      pos: "Tính từ な",
      meaning: "không giỏi, kém",
      exampleJa: "私は歌が不得意です。",
   ...
   },
   {
      ...
      hiragana: "にがてな",
      pos: "Tính từ な",
      meaning: "yếu, kém; không thích",
      exampleJa: "虫が苦手です。",
      exampleVi: "Tôi sợ côn trùng."
   },
   {
      kanji: "熱心な",
      hiragana: "ねっしんな",
      pos: "Tính từ な",
      meaning: "nhiệt tình, nhiệt huyết",
      exampleJa: "彼は勉強に熱心だ。",
      exampleVi: "Anh ấy rất nhiệt tình trong học tập."
   },
   {
      kanji: "熱心さ",
      hiragana: "ねっしんさ",
      ...
      exampleJa: "彼の熱心さに感心した。",
      exampleVi: "Tôi ấn tượng với sự nhiệt tình của anh ấy."
   },
   {
      kanji: "不熱心な",
      hiragana: "ふねっしんな",
      pos: "Tính từ な",
      meaning: "không nhiệt tình",
      exampleJa: "授業に不熱心な学生が多い。",
      exampleVi: "Có nhiều học sinh không nhiệt tình trong giờ học."
   },
   {
      kanji: "夢中な",
      hiragana: "むちゅうな",
      pos: "Tính từ な",
      meaning: "mải mê, say sưa",
      exampleJa: "彼はゲームに夢中だ。",
      exampleVi: "Anh ấy mải mê chơi game."
   },
   {
      kanji: "退屈な",
      hiragana: "たいくつな",
      ...
      exampleJa: "退屈な映画だった。",
      exampleVi: "Bộ phim thật nhàm chán."
   },
   {
      kanji: "退屈さ",
      hiragana: "たいくつさ",
      pos: "Danh từ",
      meaning: "sự chán chán, buồn tẻ",
      exampleJa: "退屈さを感じる。",
      exampleVi: "Cảm thấy sự buồn tẻ."
   },
   {
      kanji: "退屈する",
      hiragana: "たいくつする",
      pos: "Động từ",
      meaning: "cảm thấy buồn chán",
      exampleJa: "授業中によく退屈する。",
      exampleVi: "Tôi thường cảm thấy chán trong giờ học."
   },
   {
      kanji: "健康な",
      hiragana: "けんこうな",
      ...
      meaning: "khỏe mạnh",
      exampleJa: "祖父はとても健康だ。",
      exampleVi: "Ông tôi rất khỏe mạnh."
   },
   {
      kanji: "健康的な",
      hiragana: "けんこうてきな",
      pos: "Tính từ な",
      meaning: "mang tính khỏe mạnh",
      exampleJa: "健康的な生活を送る。",
      exampleVi: "Sống một cuộc sống lành mạnh."
   },
   {
      kanji: "不健康な",
      hiragana: "ふけんこうな",
      pos: "Tính từ な",
      meaning: "không khỏe mạnh",
      exampleJa: "不健康な食生活はよくない。",
      exampleVi: "Chế độ ăn uống không lành mạnh là không tốt."
   },
   {
      kanji: "苦しい",
      hiragana: "くるしい",
      pos: "Tính từ い",
      meaning: "khổ sở, khó chịu",
      exampleJa: "暑くて苦しい。",
      exampleVi: "Nóng đến mức khó chịu."
   },
   {
      kanji: "苦しさ",
      hiragana: "くるしさ",
      pos: "Danh từ",
      meaning: "nỗi khổ, sự đau đớn",
      exampleJa: "苦しさに耐える。",
      exampleVi: "Chịu đựng sự đau đớn."
   },
   {
      kanji: "苦しみ",
      hiragana: "くるしみ",
      pos: "Danh từ",
      meaning: "nỗi khổ, đau thương",
      exampleJa: "戦争の苦しみを味わった。",
      exampleVi: "Đã trải qua nỗi khổ của chiến tranh."
   },
   {
      kanji: "寝苦しい",
      hiragana: "ねぐるしい",
      pos: "Tính từ い",
      meaning: "khó ngủ, trằn trọc",
      exampleJa: "暑くて寝苦しい夜だ。",
      exampleVi: "Một đêm nóng nực khó ngủ."
   },
   {
      kanji: "聞き苦しい",
      hiragana: "ききぐるしい",
      pos: "Tính từ い",
      meaning: "khó nghe, chói tai",
      exampleJa: "彼の怒鳴り声は聞き苦しい。",
      exampleVi: "Tiếng quát tháo của anh ta thật khó nghe."
   },
   {
      kanji: "見苦しい",
      hiragana: "みぐるしい",
      pos: "Tính từ い",
      meaning: "khó coi, khó nhìn",
      exampleJa: "見苦しい態度をやめなさい。",
      exampleVi: "Hãy bỏ cái thái độ khó coi đó đi."
   },
   {
      kanji: "息苦しい",
      hiragana: "いきぐるしい",
      pos: "Tính từ い",
      meaning: "ngột ngạt, khó thở",
      exampleJa: "この部屋は暑くて息苦しい。",
      exampleVi: "Căn phòng này nóng bức đến ngột ngạt."
   },
   {
      kanji: "苦しむ",
      hiragana: "くるしむ",
      pos: "Động từ",
      meaning: "chịu đựng, đau khổ",
      exampleJa: "病気で長い間苦しんだ。",
      exampleVi: "Tôi đã chịu đựng bệnh tật suốt một thời gian dài."
   },
   {
      kanji: "苦しめる",
      hiragana: "くるしめる",
      pos: "Động từ",
      meaning: "làm cho đau khổ, gây khổ sở",
      exampleJa: "借金に苦しめられている。",
      exampleVi: "Bị nợ nần làm cho khổ sở."
   },
   {
      kanji: "平気な",
      hiragana: "へいきな",
      pos: "Tính từ な",
      meaning: "bình thản, dửng dưng",
      exampleJa: "彼は失敗しても平気な顔をしている。",
      exampleVi: "Anh ta thất bại nhưng vẫn giữ vẻ mặt bình thản."
   },
   {
      kanji: "悔しい",
      hiragana: "くやしい",
      ...
      exampleJa: "試合に負けて悔しい。",
      exampleVi: "Thua trận đấu nên thật tiếc nuối."
   },
   {
      kanji: "悔しさ",
      hiragana: "くやしさ",
      pos: "Danh từ",
      meaning: "sự tiếc nuối, sự cay cú",
      exampleJa: "悔しさをバネに努力する。",
      exampleVi: "Biến sự tiếc nuối thành động lực cố gắng."
   },
   {
      kanji: "うらやましい",
      hiragana: "うらやましい",
      ...
      exampleJa: "彼の才能がうらやましい。",
      exampleVi: "Tôi ghen tị với tài năng của anh ấy."
   },
   {
      kanji: "うらやましさ",
      hiragana: "うらやましさ",
      pos: "Danh từ",
      meaning: "sự ghen tị",
      exampleJa: "彼女の成功にうらやましさを感じた。",
      exampleVi: "Cảm thấy ghen tị với thành công của cô ấy."
   },
   {
      kanji: "うらやむ",
      hiragana: "うらやむ",
      pos: "Động từ",
      meaning: "ghen tị, ao ước",
      exampleJa: "人の幸せをうらやむな。",
      exampleVi: "Đừng ghen tị với hạnh phúc của người khác."
   },
   {
      kanji: "かゆい",
      hiragana: "かゆい",
      ...
      exampleVi: "Bị côn trùng cắn nên tay bị ngứa."
   },
   {
      kanji: "かゆさ",
      hiragana: "かゆさ",
      pos: "Danh từ",
      meaning: "cơn ngứa",
      exampleJa: "かゆさに耐えられない。",
      exampleVi: "Không chịu nổi cơn ngứa."
   },
   {
      kanji: "かゆみ",
      hiragana: "かゆみ",
      pos: "Danh từ",
      meaning: "sự ngứa ngáy",
      exampleJa: "薬を塗ったらかゆみが消えた。",
      exampleVi: "Bôi thuốc vào thì hết ngứa."
   },
   {
      kanji: "おとなしい",
      hiragana: "おとなしい",
      ...
      exampleJa: "彼女はとてもおとなしい人だ。",
      exampleVi: "Cô ấy là một người rất hiền lành."
   },
   {
      kanji: "我慢強い",
      hiragana: "がまんづよい",
      pos: "Tính từ い",
      meaning: "chịu đựng giỏi, nhẫn nại",
      exampleJa: "彼は我慢強い性格だ。",
      exampleVi: "Anh ấy có tính cách nhẫn nại."
   },
   {
      kanji: "我慢強さ",
      hiragana: "がまんづよさ",
      pos: "Danh từ",
      meaning: "sự nhẫn nại, chịu đựng tốt",
      exampleJa: "我慢強さが試される。",
      exampleVi: "Sự nhẫn nại được thử thách."
   },
   {
      kanji: "しんぼう強い",
      hiragana: "しんぼうづよい",
   ...
   },
   {
      ...
      hiragana: "がまん",
      pos: "Danh từ / Động từ する",
      meaning: "sự chịu đựng, nhẫn nại",
      exampleJa: "痛みを我慢する。",
      exampleVi: "Chịu đựng cơn đau."
   },
   {
      kanji: "正直な",
      hiragana: "しょうじきな",
      ...
      exampleJa: "彼はとても正直な人だ。",
      exampleVi: "Anh ấy là một người rất trung thực."
   },
   {
      kanji: "正直さ",
      hiragana: "しょうじきさ",
      ...
      exampleJa: "正直さは大切な美徳だ。",
      exampleVi: "Trung thực là một đức tính quan trọng."
   },
   {
      kanji: "不正直な",
      hiragana: "ふしょうじきな",
      ...
      exampleJa: "不正直な答えをした。",
      exampleVi: "Đã đưa ra một câu trả lời không trung thực."
   },
   {
      kanji: "けちな",
      hiragana: "けちな",
      ...
      exampleJa: "彼はお金にけちだ。",
      exampleVi: "Anh ta rất keo kiệt với tiền bạc."
   },
   {
      kanji: "けちけちする",
      hiragana: "けちけちする",
      pos: "Động từ",
      meaning: "keo kiệt, hà tiện",
      exampleJa: "食べ物をけちけちするな。",
      exampleVi: "Đừng có hà tiện đồ ăn."
   },
   {
      kanji: "わがままな",
      hiragana: "わがままな",
      ...
      exampleJa: "子供のようにわがままな性格だ。",
      exampleVi: "Tính cách ích kỷ như trẻ con."
   },
   {
      kanji: "積極的な",
      hiragana: "せっきょくてきな",
   ...
   },
   {
      ...
      exampleJa: "彼は消極的な態度を見せた。",
      exampleVi: "Anh ta đã thể hiện thái độ tiêu cực."
   },
   {
      kanji: "積極性がある",
      hiragana: "せっきょくせいがある",
      pos: "Cụm từ",
      meaning: "có tính tích cực",
      exampleJa: "彼女は積極性がある学生だ。",
      exampleVi: "Cô ấy là học sinh có tính tích cực."
   },
   {
      kanji: "積極性がない",
      hiragana: "せっきょくせいがない",
      pos: "Cụm từ",
      meaning: "không có tính tích cực",
      exampleJa: "積極性がないと成功できない。",
      exampleVi: "Nếu không có tính tích cực thì khó thành công."
   },
   {
      kanji: "満足な",
      hiragana: "まんぞくな",
   ...
   },
   {
      ...
      exampleJa: "サービスに不満がある。",
      exampleVi: "Tôi bất mãn với dịch vụ."
   },
   {
      kanji: "不満足な",
      hiragana: "ふまんぞくな",
      pos: "Tính từ な",
      meaning: "không thỏa mãn",
      exampleJa: "不満足な点を改善する。",
      exampleVi: "Cải thiện những điểm chưa thỏa mãn."
   },
   {
      kanji: "満足する",
      hiragana: "まんぞくする",
      ...
      exampleJa: "十分に満足している。",
      exampleVi: "Cảm thấy hoàn toàn hài lòng."
   },
   {
      kanji: "不満がある",
      hiragana: "ふまんがある",
      ...
      meaning: "có bất mãn",
      exampleJa: "会社に不満がある。",
      exampleVi: "Có bất mãn với công ty."
   },
   {
      kanji: "不満がない",
      hiragana: "ふまんがない",
      pos: "Cụm từ",
      meaning: "không có bất mãn",
      exampleJa: "特に不満がない。",
      exampleVi: "Không có bất mãn gì đặc biệt."
   },
   {
      kanji: "不安な",
      hiragana: "ふあんな",
   ...
   },
   {
      ...
      exampleJa: "両親の顔を見て安心した。",
      exampleVi: "Nhìn thấy mặt bố mẹ thì yên lòng."
   },
   {
      kanji: "心配な",
      hiragana: "しんぱいな",
      ...
      meaning: "lo lắng",
      exampleJa: "明日の天気が心配だ。",
      exampleVi: "Tôi lo lắng về thời tiết ngày mai."
   },
   {
      kanji: "不安がある",
      hiragana: "ふあんがある",
      pos: "Cụm từ",
      meaning: "có sự bất an",
      exampleJa: "試験に不安がある。",
      exampleVi: "Có sự lo lắng về kỳ thi."
   },
   {
      kanji: "不安がない",
      hiragana: "ふあんがない",
      pos: "Cụm từ",
      meaning: "không có sự bất an",
      exampleJa: "今回は不安がない。",
      exampleVi: "Lần này không có sự lo lắng nào."
   },
   {
      kanji: "大変な",
      hiragana: "たいへんな",
      ...
      exampleJa: "大変な仕事を任された。",
      exampleVi: "Được giao một công việc vất vả."
   },
   {
      kanji: "大変さ",
      hiragana: "たいへんさ",
      pos: "Danh từ",
      meaning: "sự vất vả, mức độ nghiêm trọng",
      exampleJa: "子育ての大変さを知った。",
      exampleVi: "Tôi đã hiểu sự vất vả của việc nuôi con."
   },
   {
      kanji: "大変目にあう",
      hiragana: "たいへんなめにあう",
      pos: "Cụm từ",
      meaning: "gặp chuyện khó khăn, rắc rối lớn",
      exampleJa: "昨日は大変な目にあった。",
      exampleVi: "Hôm qua tôi đã gặp chuyện rất rắc rối."
   },
   {
      kanji: "無理な",
      hiragana: "むりな",
      ...
      exampleJa: "無理なお願いをする。",
      exampleVi: "Đưa ra một yêu cầu vô lý."
   },
   {
      kanji: "無理やり",
      hiragana: "むりやり",
      pos: "Phó từ",
      meaning: "cưỡng ép, ép buộc",
      exampleJa: "無理やり連れて行かれた。",
      exampleVi: "Bị ép buộc đưa đi."
   },
   {
      kanji: "不注意な",
      hiragana: "ふちゅういな",
      pos: "Tính từ な",
      meaning: "bất cẩn, thiếu chú ý",
      exampleJa: "不注意なミスをした。",
      exampleVi: "Đã mắc một lỗi bất cẩn."
   },
   {
      kanji: "不注意さ",
      hiragana: "ふちゅういさ",
      pos: "Danh từ",
      meaning: "sự bất cẩn",
      exampleJa: "不注意さが事故の原因だ。",
      exampleVi: "Sự bất cẩn là nguyên nhân tai nạn."
   },
   {
      kanji: "楽な",
      hiragana: "らくな",
      ...
      exampleJa: "楽な仕事を探している。",
      exampleVi: "Đang tìm một công việc nhàn hạ."
   },
   {
      kanji: "面倒な",
      hiragana: "めんどうな",
      ...
      exampleJa: "面倒な手続きを省きたい。",
      exampleVi: "Muốn bỏ qua những thủ tục phiền phức."
   },
   {
      kanji: "めんどうくさい",
      hiragana: "めんどうくさい",
      ...
      exampleJa: "宿題はめんどうくさい。",
      exampleVi: "Bài tập về nhà thật phiền toái."
   },
   {
      kanji: "失礼な",
      hiragana: "しつれいな",
      ...
      exampleJa: "失礼な態度を取るな。",
      exampleVi: "Đừng có thái độ thất lễ."
   },
   {
      kanji: "失礼する",
      hiragana: "しつれいする",
      pos: "Động từ",
      meaning: "xin phép (ra về, ngắt lời...)",
      exampleJa: "お先に失礼します。",
      exampleVi: "Xin phép tôi về trước."
   },
   {
      kanji: "当然な",
      hiragana: "とうぜんな",
      ...
      meaning: "đương nhiên",
      exampleJa: "成功は当然の結果だ。",
      exampleVi: "Thành công là kết quả đương nhiên."
   },
   {
      kanji: "あたりまえ",
      hiragana: "あたりまえ",
      pos: "Danh từ / Tính từ な",
      meaning: "đương nhiên, hiển nhiên",
      exampleJa: "礼儀を守るのはあたりまえだ。",
      exampleVi: "Giữ lễ nghĩa là điều hiển nhiên."
   },
   {
      kanji: "もちろん",
      hiragana: "もちろん",
      ...
      exampleJa: "行くかどうか？もちろん行く。",
      exampleVi: "Đi hay không à? Tất nhiên là đi rồi."
   },
   {
      kanji: "意外な",
      hiragana: "いがいな",
      ...
      exampleJa: "意外な事実を知った。",
      exampleVi: "Đã biết được một sự thật bất ngờ."
   },
   {
      kanji: "意外さ",
      hiragana: "いがいさ",
      pos: "Danh từ",
      meaning: "sự bất ngờ, điều ngoài dự kiến",
      exampleJa: "意外さに驚いた。",
      exampleVi: "Ngạc nhiên vì sự bất ngờ."
   },
   {
      kanji: "意外性がある",
      hiragana: "いがいせいがある",
      pos: "Cụm từ",
      meaning: "có tính bất ngờ",
      exampleJa: "この映画は意外性がある。",
      exampleVi: "Bộ phim này có nhiều yếu tố bất ngờ."
   },
   {
      kanji: "意外性がない",
      hiragana: "いがいせいがない",
      pos: "Cụm từ",
      meaning: "không có tính bất ngờ",
      exampleJa: "その話は意外性がない。",
      exampleVi: "Câu chuyện đó chẳng có gì bất ngờ."
   },
   {
      kanji: "案外",
      hiragana: "あんがい",
      ...
      exampleJa: "試験は案外やさしかった。",
      exampleVi: "Kỳ thi lại dễ hơn mình nghĩ."
   },
   {
      kanji: "結構な",
      hiragana: "けっこうな",
      pos: "Tính từ な",
      meaning: "tốt, đủ rồi",
      exampleJa: "結構な料理をいただいた。",
      exampleVi: "Đã được thưởng thức một bữa ăn ngon."
   },
   {
      kanji: "けっこう",
      hiragana: "けっこう",
      pos: "Phó từ / Tính từ な",
      meaning: "khá, tương đối; đủ rồi",
      exampleJa: "今日はけっこう寒い。",
      exampleVi: "Hôm nay khá lạnh."
   },
   {
      kanji: "派手な",
      hiragana: "はでな",
      ...
      exampleJa: "派手な服を着ている。",
      exampleVi: "Mặc bộ quần áo lòe loẹt."
   },
   {
      kanji: "派手さ",
      hiragana: "はでさ",
      pos: "Danh từ",
      meaning: "sự lòe loẹt, sặc sỡ",
      exampleJa: "そのドレスは派手さが目立つ。",
      exampleVi: "Chiếc váy đó nổi bật vì sự sặc sỡ."
   },
   {
      kanji: "地味さ",
      hiragana: "じみさ",
      pos: "Danh từ",
      meaning: "sự giản dị, mộc mạc",
      exampleJa: "彼女の服は地味さが魅力だ。",
      exampleVi: "Quần áo giản dị của cô ấy lại có sức hút."
   },
   {
      kanji: "地味な",
      hiragana: "じみな",
      ...
      exampleJa: "地味な色を選ぶ。",
      exampleVi: "Chọn màu sắc giản dị."
   },
   {
      kanji: "おしゃれな",
      hiragana: "おしゃれな",
      pos: "Tính từ な",
      meaning: "hợp thời trang, sành điệu",
   ...
   },
   {
      ...
      hiragana: "おしゃれをする",
      pos: "Cụm từ",
      meaning: "ăn diện, chưng diện",
      exampleJa: "デートのためにおしゃれをする。",
      exampleVi: "Ăn diện để đi hẹn hò."
   },
   {
      kanji: "しゃれている",
      hiragana: "しゃれている",
      pos: "Động từ",
      meaning: "sành điệu, hợp mốt",
      exampleJa: "このカフェはしゃれている。",
      exampleVi: "Quán cà phê này rất sành điệu."
   },
   {
      kanji: "変な",
      hiragana: "へんな",
      ...
      exampleJa: "変な音が聞こえる。",
      exampleVi: "Nghe thấy âm thanh kỳ lạ."
   },
   {
      kanji: "おかしい",
      hiragana: "おかしい",
      pos: "Tính từ い",
      meaning: "buồn cười; kỳ lạ",
      exampleJa: "その話はおかしい。",
      exampleVi: "Câu chuyện đó buồn cười."
   },
   {
      kanji: "おかしな",
      hiragana: "おかしな",
      pos: "Tính từ な",
      meaning: "kỳ quặc, khác thường",
      exampleJa: "おかしな格好をしている。",
      exampleVi: "Đang mặc một bộ đồ kỳ quặc."
   },
   {
      kanji: "不思議さ",
      hiragana: "ふしぎさ",
      pos: "Danh từ",
      meaning: "sự kỳ lạ, huyền bí",
      exampleJa: "自然の不思議さに感動した。",
      exampleVi: "Ấn tượng trước sự kỳ diệu của thiên nhiên."
   },
   {
      kanji: "ましな",
      hiragana: "ましな",
      pos: "Tính từ な",
      meaning: "tốt hơn, đỡ hơn",
      exampleJa: "バスが遅れるよりは歩いたほうがましだ。",
      exampleVi: "Thà đi bộ còn hơn là xe buýt đến muộn."
   },
   {
      kanji: "むだな",
      hiragana: "むだな",
      ...
      exampleJa: "むだな努力をするな。",
      exampleVi: "Đừng nỗ lực một cách vô ích."
   },
   {
      kanji: "むだづかい",
      hiragana: "むだづかい",
      pos: "Danh từ / Động từ する",
      meaning: "sự lãng phí (tiền, thời gian)",
      exampleJa: "お金のむだづかいをやめなさい。",
      exampleVi: "Hãy ngừng việc lãng phí tiền bạc."
   },
   {
      kanji: "むだな話",
      hiragana: "むだなはなし",
      pos: "Danh từ",
      meaning: "chuyện phiếm, chuyện vô ích",
      exampleJa: "むだな話をして時間を失った。",
      exampleVi: "Nói chuyện phiếm nên đã mất thời gian."
   },
   {
      kanji: "自由な",
      hiragana: "じゆうな",
      ...
      meaning: "tự do",
      exampleJa: "自由な時間が欲しい。",
      exampleVi: "Tôi muốn có thời gian tự do."
   },
   {
      kanji: "自由な時間",
      hiragana: "じゆうなじかん",
      pos: "Cụm danh từ",
      meaning: "thời gian tự do",
      exampleJa: "休日は自由な時間が多い。",
      exampleVi: "Ngày nghỉ thì có nhiều thời gian tự do."
   },
   {
      kanji: "自由な席",
      hiragana: "じゆうなせき",
      pos: "Cụm danh từ",
      meaning: "chỗ ngồi tự do",
      exampleJa: "この映画館は自由な席です。",
      exampleVi: "Rạp chiếu phim này có chỗ ngồi tự do."
   },
   {
      kanji: "自由な行動",
      hiragana: "じゆうなこうどう",
      pos: "Cụm danh từ",
      meaning: "hành động tự do",
      exampleJa: "自由な行動を許されている。",
      exampleVi: "Được cho phép hành động tự do."
   },
   {
      kanji: "自由がある",
      hiragana: "じゆうがある",
      pos: "Cụm từ",
      meaning: "có sự tự do",
      exampleJa: "この国には自由がある。",
      exampleVi: "Ở đất nước này có tự do."
   },
   {
      kanji: "自由がない",
      hiragana: "じゆうがない",
      pos: "Cụm từ",
      meaning: "không có sự tự do",
      exampleJa: "彼には自由がない。",
      exampleVi: "Anh ta không có tự do."
   },
   {
      kanji: "自由主義",
      hiragana: "じゆうしゅぎ",
      pos: "Danh từ",
      meaning: "chủ nghĩa tự do",
      exampleJa: "自由主義の考え方に共感する。",
      exampleVi: "Tôi đồng cảm với tư tưởng chủ nghĩa tự do."
   },
   {
      kanji: "不自由な",
      hiragana: "ふじゆうな",
      pos: "Tính từ な",
      meaning: "không tự do; tàn tật, bất tiện",
      exampleJa: "足が不自由な人を助ける。",
      exampleVi: "Giúp đỡ người bị tàn tật chân."
   },
   {
      kanji: "不自由さ",
      hiragana: "ふじゆうさ",
      pos: "Danh từ",
      meaning: "sự bất tiện, không tự do",
      exampleJa: "戦争中の不自由さを語った。",
      exampleVi: "Đã kể về sự thiếu thốn trong thời chiến."
   },
];
